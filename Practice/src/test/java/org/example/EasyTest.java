...
public class EasyTest {
    ...
    @Test public void testProblem13() {
        //Problem 13: Write a program to find the maximum value in an array.
        assertEquals(4, Problem13.findMax(new int[]{1, 2, 3, 4, 3}));
        assertEquals(4, Problem13.findMax(new int[]{4, 2, 3, 1, 3}));
        assertEquals(4, Problem13.findMax(new int[]{1, 2, 3, 3, 4}));
        assertEquals(4, Problem13.findMax(new int[]{4, 4, 4, 4, 4}));
        assertEquals(1, Problem13.findMax(new int[]{1}));
    }
    @Test public void testProblem14() {
        //Problem 14: Write a program to calculate the average of the numbers in an array.
        assertEquals(2.6, Problem14.calculateAverage(new int[]{1, 2, 3, 4, 3}));
        assertEquals(2.6, Problem14.calculateAverage(new int[]{4, 2, 3, 1, 3}));
        assertEquals(2.6, Problem14.calculateAverage(new int[]{1, 2, 3, 3, 4}));
        assertEquals(4.0, Problem14.calculateAverage(new int[]{4, 4, 4, 4, 4}));
        assertEquals(1.0, Problem14.calculateAverage(new int[]{1}));
    }
}
